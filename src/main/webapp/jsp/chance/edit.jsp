...
<form id="chanceForm" action="${ctx}/chance/update" method="POST">
  ...
  <table class="query_form_table" border="0" cellPadding="3" cellSpacing="0">
    ...
    <tr>
      ...
      <th>创建时间</th>
      <td><input id="createDate" name="createDate" readonly="readonly" type="text" value="  <fmt:formatDate value="${salesChance.createDate}" pattern="yyyy-MM-dd"/>"/>
